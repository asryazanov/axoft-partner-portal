      ...
      <div className="hero">
        <div className="hero-copy">
          ...
          <ol className="hero-steps">
            <li>Выберем 1-3 заказчиков из промышленности с высоким уровнем доверия.</li>
            <li>Совместно определим 3-5 наиболее релевантных вендоров под их боли и проекты на 2026-2028 годы.</li>
            <li>Проведём первую установочную встречу с заказчиком по промышленным решениям вместе с Axoft.</li>
            <li>Соберём комплексное предложение под ТЗ заказчика: партнёр, Axoft и вендоры.</li>
            <li>Зайдём в новый бизнес плавно, с минимальными ресурсами с вашей стороны и с поддержкой экосистемы вендоров Axoft.</li>
          </ol>
